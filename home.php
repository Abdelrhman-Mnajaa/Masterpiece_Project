   ...
   <section class="center">
      <form action="search.php" method="post">
         ...
         <div class="box">
            ...
            <input type="text" name="h_location" required maxlength="100" placeholder="" class="input">
         </div>
         <div class="flex">
            <div class="box">
...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"><span><h3><?= $fetch_property['price']; ?> JOD</h3></span>  </div>
