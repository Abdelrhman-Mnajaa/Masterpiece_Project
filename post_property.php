      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <select name="bathroom" required class="input">
               ...
               <option valu ="3">3 bathrooms</option>
         ...
         <div class="box">
            <p>how many balconyies <span>*</span></p>
            <select name="balcony" required class="input">
               <option value="0">0 balcony</option>
               <option value="1">1 balcony</option>
               <option value="2">2 balconyies</option>
               <option value="3">3 balconyies</option>
               <option value="4">4 balconyies</option>
               <option value="5">5 balconyies</option>
               <option value="6">6 balconyies</option>
               <option value="7">7 balconyies</option>
               <option value="8">8 balconyies</option>
               <option value="9">9 balconyies</option>
            </select>
         </div>
         <div class="box">
            <p>carpet area <span>*</span></p>
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="how many square feets?" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="how many floor available?" class="input">
         </div>
         <div class="box">
